...
CFLAGS := -DHAVE_CONFIG_H -DDEBUG -O0 -g -fcommon # -mno-default
...
$(addsuffix .o, $(libimobiledevice_src)) : EXTRA_FLAGS := -Ilibraries $(libimobiledevice_include) -Ilibraries/libimobiledevice/common -Ilibraries/libusbmuxd/common $(libplist_include)
...
$(addsuffix .o, $(main_src)) : EXTRA_FLAGS := $(INC_CFLAGS) -Ilibraries
...
$(PROGRAM):: $(addsuffix .o, $(main_src)) libraries/libimobiledevice.a libraries/miniupnp.a libraries/libplist.a
	$(CC) -o $@ $^ $(LDFLAGS)
